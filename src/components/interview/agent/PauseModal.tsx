        ...
        <ModalHeader className="flex flex-col gap-1 pb-2">
          <div className="flex items-center justify-center mb-2">
            <div className="relative">
              ...
              <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center backdrop-blur-sm border border-white/10">
                <PauseCircleIcon className="w-12 h-12 text-blue-400" />
              </div>
            </div>
          </div>
          <h2 className="text-2xl font-bold text-center bg-gradient-to-r from-blue-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">
            Session Paused
          </h2>
        </ModalHeader>
        <ModalBody>
            ...
            {isProcessing ? (
              ...
              <div className="text-center py-4">
                <p className="text-gray-400 mb-8 text-lg font-medium">
                  Your interview session has been paused successfully. You can resume when you're ready.
                </p>
